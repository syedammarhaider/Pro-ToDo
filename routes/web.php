...
Route::middleware('auth')->group(function () {
    ...
    // Bulk operations
    Route::post('/todos/bulk-complete', [TodoController::class, 'bulkComplete'])->name('bulk-complete');
    Route::post('/todos/bulk-delete', [TodoController::class, 'bulkDelete'])->name('bulk-delete');
});
