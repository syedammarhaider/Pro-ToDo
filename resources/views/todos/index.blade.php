    ...
    <section class="stats-dashboard mb-4" aria-label="Dashboard statistics">
        <div class="row g-2 g-sm-3">
            ...
            <div class="col-6 col-sm-3 col-md-3">
                <div class="stat-card glass-effect stat-primary">
                    <div class="stat-icon">
                        <i class="fas fa-tasks"></i>
                    </div>
                    <div class="stat-content">
                        <div class="stat-number" data-stat="total">{{ $stats['total'] }}</div>
                        <div class="stat-label">Total Tasks</div>
                    </div>
                </div>
            </div>
            <div class="col-6 col-sm-3 col-md-3">
                <div class="stat-card glass-effect stat-success">
                    <div class="stat-icon">
            ...
            <div class="col-6 col-sm-3 col-md-3">
                <div class="stat-card glass-effect stat-info">
                    <div class="stat-icon">
                        <i class="fas fa-percentage"></i>
                    </div>
                    <div class="stat-content">
                        <div class="stat-number" data-stat="done">{{ $stats['total'] > 0 ? round(($stats['completed'] / $stats['total']) * 100) : 0 }}%</div>
                        <div class="stat-label">Done</div>
                    </div>
                </div>
            </div>
            <div class="col-6 col-sm-3 col-md-3">
                <div class="stat-card glass-effect stat-warning">
                    <div class="stat-icon">
            ...
            <!-- Secondary Stats Row -->
            <div class="col-6 col-sm-3 col-md-3">
                <div class="stat-card glass-effect stat-danger">
                    <div class="stat-icon">
            ...
            <div class="col-6 col-sm-3 col-md-3">
                <div class="stat-card glass-effect stat-secondary">
                    <div class="stat-icon">
                        <i class="fas fa-tag"></i>
                    </div>
                    <div class="stat-content">
                        <div class="stat-number">{{ $stats['by_category']->count() }}</div>
                        <div class="stat-label">Categories</div>
                    </div>
                </div>
            </div>
            <div class="col-6 col-sm-3 col-md-3">
                <div class="stat-card glass-effect stat-support">
                    <div class="stat-icon">
            ...
            <div class="col-6 col-sm-3 col-md-3">
                <div class="stat-card glass-effect stat-realtime">
                    <div class="stat-icon">
