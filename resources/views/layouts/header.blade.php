    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            ...
            <div class="d-flex align-items-center me-3">
                <button class="btn btn-outline-light btn-sm" id="themeToggle" title="Toggle theme" style="border: 2px solid var(--bs-navbar-color); color: var(--bs-navbar-color); transition: all 0.3s ease; background: rgba(255,255,255,0.1); backdrop-filter: blur(10px);">
